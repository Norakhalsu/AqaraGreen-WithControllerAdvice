...
public class ContractService {
  ...
  public void addContract(Integer unitId,Integer investorId,Integer clientId,Contract contract) {
      ...
      if(investor ==null){
          throw new ApiException("المستثمر غير موجود في النظام");
      }
      if(client ==null){
          throw new ApiException("العميل ليس موجود في النظام");
      }
      if(unit ==null){
          throw new ApiException("الوحدة السكنية غير موجوده في النظام ");
      }
   ...
   public void updateContract(Integer id ,Contract contract) {
        ...
        if(c == null) {
            throw new ApiException("**** العقد غير موجود بالنظام ****");
        }
  ...
  public void deleteContract(Integer id) {
    ...
    public double applyDiscount(Integer contractId) {
        ...
        if (!contract.getContractType().equalsIgnoreCase("rent")) {
            throw new ApiException("يجب ان يكون نوع الوحدة السكنية: rent ");
        }

        int rentalPeriod = RentalPeriodInMonths(contractId);

        if (rentalPeriod < 12) {
            throw new ApiException("مدة الإيجار أقل من 12 شهرا ، لا استطبع لتطبيق الخصم");
        }
    ...
    public int RentalPeriodInMonths(Integer id) {
        ...
        public String processPayment(int contractId, double paymentAmount) {
            ...
            if (contract != null) {
                ...
                throw new ApiException("لم يتم العثور في النظام على العقد برقم: " + contractId+" ");
            }
        }
    ...
    public Map<String, Double> analyzeContractsData() {
        ...
        if (allContracts.isEmpty()) {
            throw new ApiException(" لا يوجد عقود في النظام");
        }
    ...
    public String validateLeaseContractDocuments(Integer id) {
      if (contractRepository.findContractById(id) == null) {
          throw new ApiException(" **** لايوجد عقد بالنظام بهذا الرقم *** ");
      }
        Contract contract = contractRepository.findContractById(id);
        if (contract.getStartDate() == null ||
            ...
            throw new ApiException("فشل التحقق من صحة العقد");
        }
