...
public class ContractController {
    ...
    public ResponseEntity addContract(@PathVariable Integer unitId ,@PathVariable Integer investorId ,@PathVariable Integer clientId,@Valid @RequestBody Contract contract) {
        contractService.addContract(unitId,investorId,clientId,contract);
        return ResponseEntity.status(201).body(new ApiResponse(" تم اضافة العقد بنجاح"));
    }
    ...
    public ResponseEntity updateContract(@PathVariable Integer id ,@Valid@RequestBody Contract contract ) {
        ...
        return ResponseEntity.status(201).body(new ApiResponse("تم تحديث العقد بنجاح"));
    }
    ...
    public ResponseEntity deleteContract(@PathVariable Integer id){
        ...
        return ResponseEntity.status(201).body(new ApiResponse("تم حذف العقد بنجاح"));
    }
